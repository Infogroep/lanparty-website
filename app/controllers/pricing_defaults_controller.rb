  ...
  def create
    ...
    respond_to do |format|
      if @pricing_default.save
        format.html { redirect_to @pricing_default, notice: 'Pricing default was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @pricing_default.update_attributes(params[:pricing_default])
        format.html { redirect_to @pricing_default, notice: 'Pricing default was successfully updated.' }
