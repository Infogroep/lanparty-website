class StoreItemClassPricingOverridesController < ApplicationController
	...
	def index
		...
		respond_to do |format|
			format.html { render :template => 'pricing_overrides/index', :locals => { :new_path => new_store_item_class_pricing_override_path,
	...
	def new
		...
		respond_to do |format|
			format.html { render :template => 'pricing_overrides/new', :locals => { :path => store_item_class_pricing_overrides_path } }
		end
	end
	...
	def edit
		...
		respond_to do |format|
			format.html { render :template => 'pricing_overrides/edit', :locals => { :path => store_item_class_pricing_overrides_path } }
		end
	end
