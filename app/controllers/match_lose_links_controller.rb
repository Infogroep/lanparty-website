	...
	def create
		...
		respond_to do |format|
			if @match_lose_link.save
				format.html { redirect_to match_lose_links_url, flash: { info: 'Match lose link was successfully created.' } }
	...
	def update
		...
		respond_to do |format|
			if @match_lose_link.update_attributes(params[:match_lose_link])
				format.html { redirect_to match_lose_links_url, flash: { info: 'Match lose link was successfully updated.' } }
