	...
	def create
		...
		respond_to do |format|
			if @match_win_link.save
				format.html { redirect_to match_win_links_url, flash: { info: 'Match win link was successfully created.' } }
	...
	def update
		...
		respond_to do |format|
			if @match_win_link.update_attributes(params[:match_win_link])
				format.html { redirect_to match_win_links_url, flash: { info: 'Match win link was successfully updated.' } }
